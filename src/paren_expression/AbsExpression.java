...
public class AbsExpression extends ParenExpression{
    ...
    private static String[] myCommands = { "abs"};

	AbsExpression(ArrayList<Expression> operands)
	{
		myOperands = operands;
	}
	...
	public RGBColor evaluate() 
	{
			...
			return new RGBColor(Math.abs(operand1.getRed()), Math.abs(operand1.getGreen())
					,Math.abs(operand1.getBlue()));
